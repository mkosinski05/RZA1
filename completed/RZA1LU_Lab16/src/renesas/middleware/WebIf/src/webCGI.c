...
extern int cgiSwitchMonitor (PSESS pSess, PEOFILE pEoFile);
extern int cgiGetADC (PSESS pSess, PEOFILE pEoFile);
...
static const CGIFNASS gpCgiFnAss[] =
{
    ...
    {(int8_t *) "get_adc.cgi", 		cgiGetADC},
	{(int8_t *) "get_switch.cgi", 	cgiSwitchMonitor}
