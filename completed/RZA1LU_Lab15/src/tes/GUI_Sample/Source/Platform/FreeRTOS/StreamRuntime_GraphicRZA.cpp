...
#else
#define     DISP_AREA_HS                (16u)
#define     DISP_AREA_VS                (64u)
#endif
...
uint8_t video_buffer1[(VIDEO_BUFFER_STRIDE * VIDEO_BUFFER_HEIGHT) ] __attribute__ ((section(".VRAM_SECTION0")));
uint8_t video_buffer2[(VIDEO_BUFFER_STRIDE * VIDEO_BUFFER_HEIGHT) ] __attribute__ ((section(".VRAM_SECTION0")));
...
extern "C" void GRAPHIC_init_screen(void)
{
    ...
    if (error == VDC_OK)
    {
        ...
        memset((void*)video_buffer1, 0xF0, VIDEO_BUFFER_STRIDE * VIDEO_BUFFER_HEIGHT );
        memset((void*)video_buffer2, 0xF0, VIDEO_BUFFER_STRIDE * VIDEO_BUFFER_HEIGHT );
		...
		gr_disp_cnf.fb_buff          = video_buffer1;
